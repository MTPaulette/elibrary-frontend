              ...
              <div class="card my-5" style="background: transparent">
                <div class="card-body">
                  <div class="compose-email">
                    <div class="mail-box">
                      <div class="row">
                        <div class="col-md-6 col-lg-5 col-xl-4 mb-4 mb-md-0 bg-success">
                          <aside class="sm-side m-5">

                            <div class="user-head bg-warning">
                              <a class="inbox-avatar" href="javascript:;">
                                <img src="assets/images/user.jpg" alt="">
                              </a>
                              <div class="user-name">
                                <h5><a href="#">{{ user.username }}</a>
                                </h5>
                                <span><a href="#">{{ user.email }}</a></span>
                              </div>
                            </div>
                            <!-- Modal -->
                            <div class="inbox-body text-center bg-default">
                            ...
                            <ul class=" inbox-nav inbox-divider people bg-info">

                              <li class="p-2 border-bottom" v-for="requete in requetes" :key="requete.id">
                                <a href="#!" class="d-flex justify-content-between">
                                  <div class="d-flex flex-row">
                                    ...
                                    <div class="pt-1" @click="getMessages(requete.id)">
                                      <p class="fw-bold mb-0">{{ requete.User.username }}</p>
                                      <p class="small text-muted">{{ requete.Messages[0].contenu }}
                                      </p>
                                    </div>
                                  </div>
                                  <div class="pt-1">
                                    <p class="small text-muted mb-1">{{ requete.Messages[0].createdAt }}</p>
                              ...
                              <li class="p-2 border-bottom">
                                <a href="#!" class="d-flex justify-content-between">
                                  <div class="d-flex flex-row">
                                    <div> <img src="../../assets/avatar.png" alt="avatar"
                                        class="d-flex align-self-center me-3" width="60">
                                      <span class="badge bg-warning badge-dot"></span>
                                    </div>
                                    <div class="pt-1">
                                      <p class="fw-bold mb-0">Lorem ipsum dolor sit. {{requetes}}</p>
                            ...
                            <!-- <div class="inbox-body text-center">
                              <div class="btn-group">
                                <a class="btn btn-primary" href="javascript:;">
                                  <i class="fa fa-plus mr-2 pl-0"></i>Nouveau
                                </a>
                              </div>
                            </div> -->
                        ...
                        <div class="col-md-6 col-lg-7 col-xl-8 bg-danger">
                          <aside class="lg-side bg-info row">
                            <div class="col">
                              ...
                              <div v-for="message in messages" :key="message.id">
                                ...
                                <div class="d-flex flex-row justify-content-start" v-else>
                                  <img src="../../assets/avatar.png" alt="avatar 1" class="rounded-circle"
                                    style="width: 45px; height: 100%;">
                                  <div>
                                    <p class="small p-2 ms-3 mb-1 rounded-3 text-white  bg-primary">{{message.contenu}}
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatibus
                                     beatae alias rerum nulla numquam delectus natus a recusandae impedit 
                                     repellat quibusdam aut, ullam eligendi rem! Officia culpa maxime enim
                                     similique?
                                    </p>
                                    <p class="small ms-3 mb-3 rounded-3 text-muted float-end">{{ message.createdAt}}</p>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="text-muted d-flex justify-content-start align-items-center pe-3 pt-3 mt-2">
                              <form @submit.prevent="sendMessage" class="form-inline">
                                ...
                                <input type="text" class="form-control textbox" v-model="message"
                                  placeholder="Type message">

                                <a class="ms-1 text-muted" href="#!"><i class="fa fa-paperclip"></i></a>
                                <a class="ms-3 text-muted" href="#!"><i class="fa fa-smile-o"></i></a>
                                <button type="submit" class="btn ms-3"><i class="fa fa-paper-plane"></i>
                                </button>
