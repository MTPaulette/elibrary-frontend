                  ...
                  <form method="post" class="form-horizontal">
                    <div class="row form-group" v-if="!other">
                      ...
                      <div class="col-12 col-md-9">
                        ...
                        >
                          ...
                          <option
                            v-for="raison in raisons"
                            :key="raison.id"
                            v-bind:value="raison.id"
                          >
                            {{ raison.description }}
                          </option>
                    ...
                    <div class="row">
                      <div class="float-end">
                        <span
                          @click="other = !other"
                          class="fw-bold small text-end text-white mb-1 bg-secondary"
                          >Autre</span
                        >
                      </div>
                    </div>
  ...
  methods: {
    ...
    postSignalement() {
      if (this.description || this.raisonId) {
        ...
        console.log(req);
        axios
          .post("http://localhost:5000/api/signalements/", req)
          .then((res) => {
            this.loading = false;
            console.log(res.data);
            if (res.data.success) {
