    ...
    <div class="all-title-box">
      <div class="container text-center">
        <h1>
          ...
          ><span class="m_1"
            >Le meilleur choix pour tous les amoureux du code</span
          >
        </h1>
      </div>
    </div>
            ...
            <div class="course-item">
              ...
              <div class="course-br">
                <div class="course-title">
                  <h2>
                    <a href="/informatiques/matiereInfL1" title="">Licence 1</a>
                  </h2>
                </div>
                <div class="course-desc">
                  <p>
                    Vous trouverez les bases de l'informatiques dans ses
                    différents domaines: Réseaux, Sécurité, Programmation,
                    etc...
                  </p>
                </div>
