    ...
    <div class="all-title-box">
      <div class="container text-center">
        <h1>
          ...
          ><span class="m_1"
            >Tous les passionés de physique trouvent leur compte dans cette
            librairie</span
          >
        </h1>
      </div>
            ...
            <div class="course-item">
              ...
              <div class="course-br">
                ...
                <div class="course-desc">
                  <p>
                    Vous trouverez les bases de la physique dans ses différents
                    domaines: Electronique, science des matériaux, etc...
                  </p>
                </div>
              ...
              <div class="course-meta-bot">
                <ul>
                  <li>
                    <i class="fa fa-calendar" aria-hidden="true"></i>Semestre 1
                    et 2
                  </li>
                  <li>
                    <i class="fa fa-book" aria-hidden="true"></i> Livres et
                    supports de cours
                  </li>
                </ul>
              </div>
        ...
        <div class="row">
              ...
              <div class="course-br">
                ...
                <div class="course-desc">
                  <p>
                    ...
                    <strong
                      >Physique fondamentale, Science des matériaux, Physique
                      appliquée, Electronique, Physique quantique</strong
                    >
                  </p>
                </div>
                <div class="course-rating">
          ...
          <div class="col-lg-6 col-md-6 col-12">
            <div class="course-item">
              <div class="image-blog">
                <img
                  src="../../../public/static/homePage/images/blog_4.jpg"
                  alt=""
                  class="img-fluid"
                />
              </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-12">
            <div class="course-item">
              <div class="image-blog">
                <img
                  src="../../../public/static/homePage/images/blog_5.jpg"
                  alt=""
                  class="img-fluid"
                />
              </div>
          ...
          <div class="col-lg-6 col-md-6 col-12">
            <div class="course-item">
              <div class="image-blog">
                <img
                  src="../../../public/static/homePage/images/blog_6.jpg"
                  alt=""
                  class="img-fluid"
                />
              </div>
