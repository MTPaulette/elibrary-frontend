<template lang="">
    <div class="content mt-3" v-if="!successful">
          ...
          <div class="col-lg-11 mx-auto">
            <div class="card">
              ...
              <div class="card-body card-block">
                <form action="/Document" method="POST" enctype="multipart/form-data" class="form-horizontal" @submit.prevent="newDocument">
                ...
                <button type="reset" class="btn btn-danger btn-sm">
                  <i class="fa fa-ban"></i> <router-link to="/NewDocument">Annuler</router-link> 
                </button>
                </form>
              </div>
            </div>
      ...
      <!-- .if success -->
      <div v-if="successful">
        <div class="alert alert-success" role="alert">Document enregistré avec succès!</div>
      </div>
    </div>
    <!-- .content -->
  </template>
  ...
  computed: {
    ...
    methods: {
      ...
      newDocument() {
        ...
        axios.post("http://localhost:5000/api/documents/createDocument", formData).then((res) => {
          if (!res.data.success) {
