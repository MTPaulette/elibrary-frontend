      ...
      <ul class="nav navbar-nav">
        ...
        <li class="menu-item-has-children dropright">
          ...
          <ul class="sub-menu children dropdown-menu">
            ...
            <li>
              <i class="fa fa-id-badge"></i><a href="ui-badges.html">Badges</a>
            </li>
            ...
            <li>
              <i class="fa fa-id-card-o"></i><a href="ui-cards.html">Cards</a>
            </li>
            <li>
            ...
            <li>
              <i class="fa fa-fire"></i><a href="ui-modals.html">Modals</a>
            </li>
            <li>
              <i class="fa fa-book"></i><a href="ui-switches.html">Switches</a>
            </li>
        ...
        <li class="menu-item-has-children active dropright">
          <a
            href="#"
            class="dropdown-toggle"
            data-toggle="dropdown"
