        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <strong class="card-title">ENSEIGNANTS ACTIFS</strong>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                    ...
                    <tr
                      ...
                      <td>
                        <label class="switch switch-3d switch-danger mr-3">
                          <input type="checkbox" class="switch-input"  @click="unblockTeacher(teacher.id)">
...
export default {
  ...
  methods: {
    ...
    //********************************** */
    fetchData() {
        axios.get("http://localhost:5000/api/users/TousEnseignantsBloques").then((res) => {
    ...
    unblockTeacher(teacherId) {
      //if(this.checkValue) {
        axios.get("http://localhost:5000/api/users/debloquerUser/"+teacherId).then((res) => {
